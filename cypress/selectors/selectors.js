export const selectors = {
  ...
  search: {
    ...
    searchBoxOverlay:
      "SearchBoxOverlayComponent_o-search-box-overlay-component__duZl2",
    searchButton: 'button[class*="search-button"]',
    searchField: "div.magic-box-input",
    searchFieldSuggestedList:
      "div.magic-box-suggestions.magic-box-hasSuggestion",
    ...
    typeSearchDropDownValidOption:
      '.coveo-dynamic-facet-value[data-value="Video"]',
    ...
    topicSearchDropDownValidOption:
      '.coveo-dynamic-facet-value[data-value="Health Science"]',
    ...
    connectivityTopicOption:
      '.CoveoDynamicFacet[data-id="@sgstopic"] .coveo-dynamic-facet-value[data-value="Connectivity"]',
    clearAllFiltersButton:
      ".coveo-breadcrumb-clear-all.coveo-accessible-button",
  ...
  contact: {
    inquiryType:
      "select#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_939a3ae7-e610-4d2d-8e94-e58b58d58353__Value",
    ...
    subject:
      "select#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_430c7641-301b-41b0-9c78-433be72dfa45__Value",
    typeOfFeedback:
      "select#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_b7e0bf42-2c3d-43e1-b0be-955314467d90__Value",
    ...
    locationDropDown:
      "select#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_48820920-a124-41be-b7f3-94343795ee65__Value",
    firstName:
      "input#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_28fb90f9-75de-43ac-99e2-e64db1933595__Value",
    lastName:
      "input#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_89714a4b-8bf7-4349-bb16-822b8891522b__Value",
    email:
      "input#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_ac3dc88f-1b0d-4056-a5fc-53e07068a55e__Value",
    companyName:
      "#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_5a73af63-7d05-45b3-9e4d-0460f9c40264__Value",
    jobTitle:
      "input#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_6c06bf07-454c-4521-b225-305b1a1c6ba8__Value",
    phone:
      "input#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_0f58bcce-5839-4b47-a5e4-29be5e109f76__Value",
    questionField:
      "#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_Fields_8831cc05-79e7-473e-8565-a7dae2c89d22__Value",
    agreeCheckBox: "CheckboxWithRichTextField___input__R5BLN",
    sendMessageButton:
      "button#fxb_0e656d89-23a3-4b5c-aecf-d0bf5817bce9_fa966c1f-2d5b-4597-a06b-15f36e86e22e",
    formIsSubmittedSuccessfully: ".form-step-2",
    formIsSubmittedSuccessfullyThankYou:
      "#id-c87732c1-5e6f-43fe-8136-7ae10bb47838",
    contactButton: 'a[href*="contact-form"]',
    disabledContactButtonClass: "--disabled",
    fieldInvalidMessage:
      'div[class="Form_o-form-component__invalid__91zNa relative"]',
  ...
  findJob: {
    ...
    noResultLogo:
      '[class="StartSearch_a-start-search__logo-wrapper__W7UUR py-7"]',
    remoteCheckBox: '[class="flex items-center cursor-pointer"]',
    checkBox: '[type="checkbox"]',
    allResultsArea: ".AccordionComponent_o-accordion-component__y_QAz",
    typeOfWorkResult:
      "dl.ResultItemSmartRecruiters_a-result-item-smart-recruiters__metadata__g2W72",
    countryCityResult:
      "dl.ResultItemSmartRecruiters_a-result-item-smart-recruiters__location__CFCLx div dd",
    ...
    departmentAccordionName:
      ".AccordionItemComponent_accordion-item__headline__Fif8D",
    ...
    contractTypeResult:
      "dl.ResultItemSmartRecruiters_a-result-item-smart-recruiters__metadata__g2W72 div dd",
    cityDropDown: "div div#react-select-3-placeholder",
    jobTitle:
      "div.ResultItemSmartRecruiters_a-result-item-smart-recruiters__Wd2pH a",
  ...
  homePage: {
    ...
    heroBannerHomePageItemMainImage:
      "a.HeroBannerHomepageItemComponent_o-hero-banner-homepage-item-component__link__yqHJ_ img",
    currentCountryInNavigationBar:
      ".NavigationUtilityDesktop_o-navigation-utility-desktop__4blA_  button span",
    countryValueInCountrySelectionMenu:
      "a.CountryLanguageSelectorItem_m-country-language-selector-item__link__RoEYl",
    ...
    changeLocationButtonInFooter:
      "button.LocationSelectorComponent_o-location-selector-component__locator-button__qhrGz",
    currentCountryLanguageInFooter:
      ".LocationSelectorComponent_o-location-selector-component__current__p_aEC strong",
  },
  ...
  scriptDividend: {
    ...
    errorMessage:
      ".ScriptDividendCalculatorComponent_o-dividend-calculator-component__error__bTThc",
    dividendCalculatorArea:
      ".ScriptDividendCalculatorComponent_o-dividend-calculator-component__container__qnjZP",
    ...
    errorMessageWhenAllFieldsEmpty:
      ".FieldValidationErrors_m-field-validation-error__invalid__FGARs",
  ...
  subscriptionCenter: {
    topicOption:
      "div.SubscriptionCenterSelector_m-subscription-center-selector__F1_zR span",
    buttonNext: "span.button__text",
    backButton:
      "div.SubscriptionCenterBack_a-subscription-center-back__button__cZQv0",
    Step2Title:
      "h3.SubscriptionCenterStep_m-subscription-center-step__title__EyMt5",
    itemOption:
      "button.SubscriptionCenterCard_a-subscription-center-card__button__30l2B",
    firstNameField:
      "input#fxb_6ff95bc7-b7f4-4afb-8068-1c4008ffd559_Fields_7c0ab4ee-c584-4e19-b686-ac0aeaea501b__Value",
    lastNameField:
      "input#fxb_6ff95bc7-b7f4-4afb-8068-1c4008ffd559_Fields_07ed15bb-3894-4aa1-93be-2fd22d1ca09b__Value",
    emailField:
      "input#fxb_6ff95bc7-b7f4-4afb-8068-1c4008ffd559_Fields_dbd90087-db38-4068-9c0c-6556457845c3__Value",
    agreementCheckBox: '.Checkbox_m-checkbox__mBUkr input[type="checkbox"]',
    submitButton: 'button[type="submit"]',
    finalPageTitle:
      "div.SubscriptionCenterStep_m-subscription-center-step__steps__3kYks",
  },

  certifiedClientDirectory: {
    searchByCompanyField: 'input#companyName',
    locationField: 'select#location',
    agreeCheckBox: 'input#agree',
    buttonSearch: 'button#search',
    resultTable: '.CertifiedClientDirectoryItem_a-certified-client-directory-item__header__nG3Am',
    locationDropDownList: 'select#location',
    noResults: 'div.CertifiedClientDirectoryComponent_o-certified-client-directory-component__content__iCm4k',
    certificationIdField: 'input#certificationId'
